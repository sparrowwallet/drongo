...
public class PSBTTest {
    ...
    @Test
    public void validP2pkhP2shP2wpkhOneInputEmptyOutputs() {
        ...
        Assert.assertEquals("47304402204759661797c01b036b25928948686218347d89864b719e1f7fcf57d1e511658702205309eabf56aa4d8891ffd111fdf1336f3a29da866d7f8486d75546ceedaf93190121035cdc61fc7ba971c0b501a646a2a83b102cb43881217ca682dc86e2d73fa88292", psbt1.getPsbtInputs().get(0).getFinalScriptSig().getProgramAsHex());
        Assert.assertEquals("OP_HASH160 3545e6e33b832c47050f24d3eeb93c9c03948bc7 OP_EQUAL", psbt1.getPsbtInputs().get(1).getWitnessUtxo().getScript().toString());
    ...
    @Test
    public void validP2pkhWithSigHash() {
        String psbt = "";
        PSBT psbt1 = PSBT.fromString(psbt);
        Assert.assertEquals(Transaction.SigHash.ALL, psbt1.getPsbtInputs().get(0).getSigHash());
        Assert.assertEquals(301L, psbt1.getFee().longValue());
    }

    @Test
    public void validP2pkhP2shP2wpkhTwoInputsTwoOutputs() {
        ...
        Assert.assertEquals("m/0'/0'/2'", psbt1.getPsbtOutputs().get(0).getDerivedPublicKeys().values().iterator().next().getDerivationPath());
    }

    @Test
    public void validP2shP2wpkhMultisigPartialSignature() {
    ...
    @Test
    public void validP2wshMultisigWithXpubs() {
    ...
    @Test
    public void validUnknownInputs() {
    ...
    @Test
    public void validP2wpkh2InputsWithXpub() {
    ...
    @Test(expected = IllegalStateException.class)
    public void invalidWitnessUtxoForNonWitnessInput() {
        String psbt = "";
        PSBT psbt1 = PSBT.fromString(psbt);
    }

    @Test(expected = IllegalStateException.class)
    public void invalidNonWitnessUtxoDoesNotMatchRedeemScriptPubKey() {
    ...
    @Test(expected = IllegalStateException.class)
    public void invalidWitnessUtxoDoesNotMatchRedeemScriptPubKey() {
        String psbt = "";
        PSBT psbt1 = PSBT.fromString(psbt);
    }

    @Test(expected = IllegalStateException.class)
    public void invalidWitnessUtxoDoesNotMatchWitnessScriptPubKey() {
        String psbt = "";
        PSBT psbt1 = PSBT.fromString(psbt);
    }

    @Test
    public void validCreatorTwoInputsTwoOutputs() {
    ...
    @Test
    public void validUpdaterTwoInputsTwoOutputs() {
    ...
    @Test
    public void validSignerTwoInputsTwoOutputs() {
        String psbt = "";
        PSBT psbt1 = PSBT.fromString(psbt);
    ...
    @Test
    public void validCombinerTwoInputsTwoOutputs() {
    ...
    @Test
    public void validFinalizerTwoInputsTwoOutputs() {
