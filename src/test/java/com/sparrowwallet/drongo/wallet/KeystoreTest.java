...
public class KeystoreTest {
    ...
    public void testFromSeed() throws MnemonicException {
        ...
        DeterministicSeed seed = new DeterministicSeed("absent essay fox snake vast pumpkin height crouch silent bulb excuse razor", "", 0, DeterministicSeed.Type.BIP39);
        Keystore keystore = Keystore.fromSeed(seed, PolicyType.SINGLE_HD, p2pkh.getDefaultDerivation());
    ...
    void bip32TestVector1() throws MnemonicException {
        ...
        Keystore keystore = Keystore.fromMasterPrivateExtendedKey(mpek, PolicyType.SINGLE_HD, KeyDerivation.parsePath("m"));
        ...
        Keystore keystore0h = Keystore.fromMasterPrivateExtendedKey(mpek, PolicyType.SINGLE_HD, KeyDerivation.parsePath("m/0H"));
        ...
        Keystore keystore0h1 = Keystore.fromMasterPrivateExtendedKey(mpek, PolicyType.SINGLE_HD, KeyDerivation.parsePath("m/0H/1"));
        ...
        Keystore keystore0h12h = Keystore.fromMasterPrivateExtendedKey(mpek, PolicyType.SINGLE_HD, KeyDerivation.parsePath("m/0H/1/2H"));
        ...
        Keystore keystore0h12h2 = Keystore.fromMasterPrivateExtendedKey(mpek, PolicyType.SINGLE_HD, KeyDerivation.parsePath("m/0H/1/2H/2"));
        ...
        Keystore keystore0h12h21000000000 = Keystore.fromMasterPrivateExtendedKey(mpek, PolicyType.SINGLE_HD, KeyDerivation.parsePath("m/0H/1/2H/2/1000000000"));
    ...
    void bip32TestVector2() throws MnemonicException {
        ...
        Keystore keystore0 = Keystore.fromMasterPrivateExtendedKey(mpek, PolicyType.SINGLE_HD, KeyDerivation.parsePath("m/0"));
        ...
        Keystore keystore1 = Keystore.fromMasterPrivateExtendedKey(mpek, PolicyType.SINGLE_HD, KeyDerivation.parsePath("m/0/2147483647H"));
        ...
        Keystore keystore2 = Keystore.fromMasterPrivateExtendedKey(mpek, PolicyType.SINGLE_HD, KeyDerivation.parsePath("m/0/2147483647H/1"));
        ...
        Keystore keystore3 = Keystore.fromMasterPrivateExtendedKey(mpek, PolicyType.SINGLE_HD, KeyDerivation.parsePath("m/0/2147483647H/1/2147483646H"));
        ...
        Keystore keystore4 = Keystore.fromMasterPrivateExtendedKey(mpek, PolicyType.SINGLE_HD, KeyDerivation.parsePath("m/0/2147483647H/1/2147483646H/2"));
    ...
    void bip32TestVector4() throws MnemonicException {
        ...
        Keystore keystore0h1h = Keystore.fromMasterPrivateExtendedKey(mpek, PolicyType.SINGLE_HD, KeyDerivation.parsePath("m/0H/1H"));
    ...
    void bip93TestVectors() throws MnemonicException {
        ...
        Keystore keystore1 = Keystore.fromMasterPrivateExtendedKey(testVector1MPEK, PolicyType.SINGLE_HD, KeyDerivation.parsePath("m"));
        ...
        Keystore keystore2 = Keystore.fromMasterPrivateExtendedKey(testVector2MPEK, PolicyType.SINGLE_HD, KeyDerivation.parsePath("m"));
        ...
        for(String secretString : testVector3SecretShares) {
            ...
            Keystore keystore3 = Keystore.fromMasterPrivateExtendedKey(testVector3MPEK, PolicyType.SINGLE_HD, KeyDerivation.parsePath("m"));
        ...
        for(String secretString : testVector4SecretShares) {
            ...
            Keystore keystore4 = Keystore.fromMasterPrivateExtendedKey(testVector4MPEK, PolicyType.SINGLE_HD, KeyDerivation.parsePath("m"));
        ...
        Keystore keystore5 = Keystore.fromMasterPrivateExtendedKey(testVector5MPEK, PolicyType.SINGLE_HD, KeyDerivation.parsePath("m"));
